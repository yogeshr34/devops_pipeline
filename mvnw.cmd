...
@REM set %HOME% to equivalent of C:\Users\Lenovo
...
echo JAVA_HOME = "%JAVA_HOME%">%TEMP%\mvn_error.txt
echo Please set the JAVA_HOME variable in your environment to match the >>%TEMP%\mvn_error.txt
echo location of your Java installation. >>%TEMP%\mvn_error.txt
echo. >>%TEMP%\mvn_error.txt
type %TEMP%\mvn_error.txt >&2
del /F /Q %TEMP%\mvn_error.txt 1>nul 2>&1
goto error
